...
<div class="modal" id="AddNotifyModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="FormModalAddNotify" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="CloseFormNotify" type="button" class="btn btn-secondary" data-dismiss="modal"

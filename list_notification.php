...
<section id="book-a-table" class="book-a-table">
    <div class="container mt-5" data-aos="fade-up">
        <table class="table table-striped table-bordered table-hover table-checkable" id="idtabNotify">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="title">View Book Table</h4>
            </div>
                ...
                <form role="form"  method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="table_id" id="table_id" class="custom-select mr-sm-2" required disabled>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            <input type="number" class="form-control" name="many_people" id="many_people"
                                   placeholder="How Many People" required autocomplete="off" min="1" readonly="readonly">
                        </div>
                    </div>
                    <br>
                    <div class="form-row">
                    ...
                    <br>
                    <div class="form-row">
                        <label class="control-label col-md-2" for="email">Created By *</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="created_by" id="created_by" placeholder="created_by" required
                                   autocomplete="off" readonly="readonly">
                        </div>
                        <label class="control-label col-md-2" for="time">Created at *</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="created_at" id="created_at" placeholder="created_at" required
                                   autocomplete="off" readonly="readonly">
                        </div>
                    </div>
                    <br>
                    <div class="form-row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" id="special_request" name="special_request"
                                      placeholder="Special Request" autocomplete="off" readonly="readonly"></textarea>
                        </div>

                    </div>
                    <br>
                    <div class="modal-footer">
                        <button id="AcceptBook"   type="button" class="btn btn-success">Accept</button>
                        <button id="RefuseBook"  type="button" class="btn btn-danger">Refuse</button>
                        <button id="CloseFormViewBook" type="button" class="btn btn-secondary" data-dismiss="modal"
